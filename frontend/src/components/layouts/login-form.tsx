    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 px-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="space-y-3">
          <button className="w-full flex items-center justify-center gap-3 py-2 px-4 border border-slate-300 rounded-lg hover:bg-slate-50 transition-colors">
          ...
          <button className="w-full flex items-center justify-center gap-3 py-2 px-4 border border-slate-300 rounded-lg hover:bg-slate-50 transition-colors">
            ...
            <span className="text-slate-700 font-medium">Đăng nhập với Facebook</span>
          </button>
        </div>
